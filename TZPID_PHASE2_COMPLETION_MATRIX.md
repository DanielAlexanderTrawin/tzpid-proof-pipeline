...
| Hubble breathing enclosure | spine_bridge | n/a | hubble_breathing_closed_distance_plus_friedmann_cpl_scaffold | clean_build | python_certificate | critical | hubble_breathing_cpl_scaffold_locked | Next replace parameter-style CMB/BAO/SN anchors with observed data tables and fit residual minimization over H0, Omega_m, Omega_K, w0, and wa. |
...
| 3 | Hubble breathing enclosure | Supplies the clock, observable distance fingerprint, typed Friedmann component carrier, and CPL dynamic-dark-energy certificate for the nested hypersphere. | Replace parameter-style CMB/BAO/SN anchors with observed data tables and fit residual minimization over H0, Omega_m, Omega_K, w0, and wa. |
...
| Hubble breathing enclosure | 49 | 74 | 34 | 20 | 5 |
