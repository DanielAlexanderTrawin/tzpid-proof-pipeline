...
|---|---|---:|---|---|---|---|---|---|
| Hyperspherical Bessel residual bridge | paper_core | 6 | hol_analysis_integral_bessel_policy_delta_alpha_phase3_hdf5_shell_check | clean_build | yes | critical | phase2_5_phase3_hdf5_shell_check_done | Next formalize the Phase3 HDF5 observable contract and then lift the nested hyperspherical enclosure spine from abstract S3/projection predicates into typed projection-map semantics. |
