...
| Hubble breathing enclosure | spine_bridge | n/a | hubble_breathing_closed_distance_plus_friedmann_pantheon_planck_likelihoods | clean_build | python_certificate | critical | hubble_breathing_pantheon_planck_likelihoods_locked | Next add the DESI DR2 BAO covariance likelihood lane, then combine Pantheon+, Planck distance priors, and DESI chi-square terms. |
...
| 3 | Hubble breathing enclosure | Supplies the clock, observable distance fingerprint, typed Friedmann carrier, CPL certificate, observed-summary residual lane, Pantheon+ raw covariance likelihood, and Planck compressed distance-prior likelihood. | Add the DESI DR2 BAO covariance likelihood lane, then combine Pantheon+, Planck distance priors, and DESI chi-square terms. |
...
| Hubble breathing enclosure | 69 | 101 | 42 | 20 | 5 |
