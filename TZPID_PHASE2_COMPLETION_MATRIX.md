...
|---|---|---:|---|---|---|---|---|---|
| Hyperspherical Bessel residual bridge | paper_core | 6 | hol_analysis_integral_bessel_policy_delta_alpha_phase_bridge | clean_build | yes | critical | phase2_5_delta_alpha_bridge_set | Next compare predicted shell radii against simulation peak positions, then lift the nested hyperspherical enclosure spine from abstract S3/projection predicates into typed projection-map semantics. |
...
|---|---:|---:|---:|---:|---:|
| Hyperspherical Bessel residual bridge | 42 | 61 | 26 | 5 | 0 |
