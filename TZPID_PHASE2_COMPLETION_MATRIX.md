...
| Matter creation spine | gold_spine | n/a | energy_matter_focus_plus_threshold_density_mass_energy_curvature_carrier_plus_temporal_emergence_flow | clean_build | yes | critical | matter_creation_temporal_flow_locked | Next attach an executable Python/Wolfram certificate plotting rho_vac(t), J_emerge(t), rho_matter(t), and total-transfer conservation over a time grid. |
