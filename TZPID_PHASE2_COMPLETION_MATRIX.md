...
|---|---|---:|---|---|---|---|---|---|
| Hyperspherical Bessel residual bridge | paper_core | 6 | hol_analysis_integral_plus_bessel_interval_policy | clean_build | yes | critical | phase2_5_bessel_policy_set | Next lift the nested hyperspherical enclosure spine from abstract S3/projection predicates into typed projection-map semantics, reusing the Bessel interval policy for mode roots. |
...
|---:|---|---|---|
| 1 | Hyperspherical Bessel residual bridge | Paper core with concrete algebra and certificates already present. | The kernel integral is proved in HOL-Analysis, and Bessel roots are now an explicit external Wolfram interval-certificate policy with HOL-proved drop bounds. |
...
| 5 | Magnetic/torsion | High-value bridge between gyromagnetic motion, helicity, Elsasser balance, and matter dynamics. | Move helicity and torsion from scalar guards toward vector-calculus/MHD semantics. |
...
|---|---:|---:|---:|---:|---:|
| Hyperspherical Bessel residual bridge | 38 | 56 | 22 | 5 | 0 |
