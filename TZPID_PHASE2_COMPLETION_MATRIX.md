...
|---|---|---:|---|---|---|---|---|---|
| Hyperspherical Bessel residual bridge | paper_core | 6 | hol_analysis_integral_proved | clean_build | yes | critical | phase2_5_hol_integral_set | Next decide whether to promote Bessel special-function zeros from Wolfram certificates into a selected HOL special-function library or keep them as certified external numerics. |
...
|---:|---|---|---|
| 1 | Hyperspherical Bessel residual bridge | Paper core with concrete algebra and certificates already present. | The causal exponential kernel now has a HOL-Analysis improper integral proof: integral over {0..} equals 1 for positive decay time. |
...
|---|---:|---:|---:|---:|---:|
| Hyperspherical Bessel residual bridge | 32 | 51 | 20 | 5 | 0 |
