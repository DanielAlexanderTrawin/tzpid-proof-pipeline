...
| Gyromagnetic movement | movement_spine | 7 | focus_certificate_plus_phase4_phase5_phase5_5_spatial_boundary_plus_phase6_circulation_diagnostic | clean_build | yes | critical | phase5_6_spatial_boundary_locked_phase6_circulation_candidate_failed | Next recompute Phase 6 circulation around a loop enclosing a wrapped phase singularity or vortex core; current HDF5 does not satisfy 2*pi*m quantization. |
...
| 2 | Gyromagnetic movement | Central movement-mechanism spine with Wolfram-backed checks plus Phase 4, Phase 5, Phase 5.5, Phase 5.6, and a Phase 6 circulation diagnostic. | Recompute the Phase 6 circulation check around a wrapped phase/vortex-core loop so the candidate can attempt a real 2*pi*m quantization lock. |
...
| Gyromagnetic movement | 59 | 68 | 28 | 15 | 19 |
