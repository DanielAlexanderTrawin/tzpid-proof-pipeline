...
|---|---|---:|---|---|---|---|---|---|
| Bessel residual spinal tap | paper_core | 6 | concrete_algebra_plus_certificate | clean_build | yes | critical | phase2_strengthen | Formalize exponential-kernel integral and keep Bessel special-function zeros tied to Wolfram certificates until HOL special functions are selected. |
...
|---:|---|---|---|
| 1 | Bessel residual spinal tap | Paper core with concrete algebra and certificates already present. | Formalize the exponential kernel integral and explicitly connect the Wolfram Bessel-root certificates. |
...
|---|---:|---:|---:|---:|---:|
| Bessel residual spinal tap | 29 | 40 | 12 | 5 | 12 |
