...
def build_rows() -> list[dict[str, str | int]]:
    ...
    core_rows = [
        ...
        dict(
            ...
            queue_status="",
            level="hubble_breathing_closed_distance_plus_friedmann_pantheon_planck_desi_likelihoods",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
            wolfram="python_certificate",
            priority="critical",
            completion="hubble_breathing_pantheon_planck_desi_likelihoods_locked",
            next_upgrade="Next combine Pantheon+, Planck distance priors, and DESI DR2 BAO chi-square terms into one joint Hubble/Friedmann certificate.",
        ),
        dict(
            ...
            level="focus_certificate_plus_phase4_phase5_phase5_5_spatial_boundary_plus_phase6_corrected_winding",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
            wolfram="yes",
            priority="critical",
            completion="phase6_corrected_winding_locked",
            next_upgrade="Next lift corrected winding from scalar loop certificates into a general loop-index theorem for wrapped phase fields and vortex-core enclosure.",
        ),
        dict(
            ...
            level="focus_certificate_plus_typed_ratio_selection",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
            wolfram="yes",
            priority="high",
            completion="typed_ratio_selection_locked",
            next_upgrade="Next lift typed ratio selection into coupled-oscillator stability and capture-basin semantics.",
        ),
        dict(
            ...
            queue_status="",
            level="golden_reciprocal_fixed_point_plus_crystal_trace_hinge",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
...
def write_md(rows: list[dict[str, str | int]]) -> None:
    ...
    upgrade_order = [
        ...
        (
            ...
            "Supplies the clock, observable distance fingerprint, typed Friedmann carrier, CPL certificate, observed-summary residual lane, Pantheon+ raw covariance likelihood, Planck compressed distance-prior likelihood, and DESI DR2 BAO covariance likelihood.",
            "Combine Pantheon+, Planck distance priors, and DESI DR2 BAO chi-square terms into one joint certificate.",
        ),
        (
