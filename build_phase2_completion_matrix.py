...
def build_rows() -> list[dict[str, str | int]]:
    ...
    core_rows = [
        ...
        dict(
            ...
            level="focus_certificate_plus_phase4_phase5_phase5_5_plus_spatial_boundary",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
            wolfram="yes",
            priority="critical",
            completion="phase5_6_spatial_boundary_locked",
            next_upgrade="Next move from finite/uniform spatial domains to full spatial/PDE or manifold boundary semantics.",
        ),
        dict(
