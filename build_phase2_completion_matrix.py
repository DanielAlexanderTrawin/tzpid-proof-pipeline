...
def build_rows() -> list[dict[str, str | int]]:
    ...
    core_rows = [
        ...
        dict(
            ...
            queue_status="",
            level="hubble_breathing_closed_distance_plus_friedmann_pantheon_planck_likelihoods",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
            wolfram="python_certificate",
            priority="critical",
            completion="hubble_breathing_pantheon_planck_likelihoods_locked",
            next_upgrade="Next add the DESI DR2 BAO covariance likelihood lane, then combine Pantheon+, Planck distance priors, and DESI chi-square terms.",
        ),
        dict(
...
def write_md(rows: list[dict[str, str | int]]) -> None:
    ...
    upgrade_order = [
        ...
        (
            ...
            "Supplies the clock, observable distance fingerprint, typed Friedmann carrier, CPL certificate, observed-summary residual lane, Pantheon+ raw covariance likelihood, and Planck compressed distance-prior likelihood.",
            "Add the DESI DR2 BAO covariance likelihood lane, then combine Pantheon+, Planck distance priors, and DESI chi-square terms.",
        ),
        (
