...
def build_rows() -> list[dict[str, str | int]]:
    ...
    core_rows = [
        ...
        dict(
            ...
            queue_status="",
            level="hubble_breathing_closed_distance_plus_friedmann_cpl_scaffold",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
            wolfram="python_certificate",
            priority="critical",
            completion="hubble_breathing_cpl_scaffold_locked",
            next_upgrade="Next replace parameter-style CMB/BAO/SN anchors with observed data tables and fit residual minimization over H0, Omega_m, Omega_K, w0, and wa.",
        ),
        dict(
...
def write_md(rows: list[dict[str, str | int]]) -> None:
    ...
    upgrade_order = [
        ...
        (
            ...
            "Supplies the clock, observable distance fingerprint, typed Friedmann component carrier, and CPL dynamic-dark-energy certificate for the nested hypersphere.",
            "Replace parameter-style CMB/BAO/SN anchors with observed data tables and fit residual minimization over H0, Omega_m, Omega_K, w0, and wa.",
        ),
        (
