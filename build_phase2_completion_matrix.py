...
def build_rows() -> list[dict[str, str | int]]:
    ...
    core_rows = [
        ...
        dict(
            ...
            queue_status="",
            level="hubble_breathing_closed_distance_plus_friedmann_observed_summary_fit",
            typed_carrier="yes",
            assumptions="yes",
            isabelle="clean_build",
            wolfram="python_certificate",
            priority="critical",
            completion="hubble_breathing_observed_summary_fit_locked",
            next_upgrade="Next replace diagonal published-summary constraints with raw CMB distance priors, DESI BAO covariance tables, and Pantheon+ likelihood data.",
        ),
        dict(
...
def write_md(rows: list[dict[str, str | int]]) -> None:
    ...
    upgrade_order = [
        ...
        (
            ...
            "Supplies the clock, observable distance fingerprint, typed Friedmann carrier, CPL dynamic-dark-energy certificate, and observed-summary residual lane.",
            "Replace diagonal published-summary constraints with raw CMB distance priors, DESI BAO covariance tables, and Pantheon+ likelihood data.",
        ),
        (
